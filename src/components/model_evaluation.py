...
from src.entity.artifact import DataValidationArtifact,ModelTrainerArtifact,ModelEvaluationArtifact
        ...
        try:
            ...
            if not model_resolver.is_model_exists():
                model_evaluation_artifact = ModelEvaluationArtifact(
                    ...
                    train_model_metric_artifact = self.model_trainer_artifact.test_metric_artifact,  # type: ignore
            ...
            y_trained_pred = train_model.predict(df) # type: ignore
            y_latest_pred  = latest_model.predict(df) # type: ignore
            ...
            model_evaluation_artifact = ModelEvaluationArtifact(
                    ...
                    trained_model_path = train_model_file_path, 
                    train_model_metric_artifact = trained_metric,  # type: ignore
